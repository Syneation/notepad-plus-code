...
public: void openFile(OpenFileDialog^ openFileDialog1, Label^ nameFile, Label^ notifications,Label^ encoding, RichTextBox^ richTextBox1, System::String^ Text)
	{
		try {
			Stream^ stream;
			...
			if (openFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
				...
				Text = "Notepad+ " + Path::GetFileName(nameFile->Text);
			}
		}
		catch (Exception^ ex) {
...
public: void fileSaveAs(RichTextBox^ richTextBox1, Label^ nameFile, Label^ notifications, Label^ encoding, System::String^ Text)
	{
		helperRich HRich;
...
public: void fileSave(RichTextBox^ richTextBox1, Label^ nameFile, Label^ notifications, Label^ encoding, System::String^ Text)
	{
		...
		{
			fileSaveAs(richTextBox1, nameFile, notifications, encoding, Text); // If the file is new, call "Save as"
		}
	}
